...
@section('title', 'Add Voice Option')
...
<div>
    ...
    <div class="mt-8">
        <div class="max-w-3xl mx-auto">
            <form action="{{ route('admin.voice-options.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
                    <div class="md:grid md:grid-cols-3 md:gap-6">
                        <div class="md:col-span-1">
                            ...
                            <p class="mt-1 text-sm text-gray-500">
                                Configure the voice settings and parameters.
                            </p>
                        </div>
                        <div class="mt-5 md:mt-0 md:col-span-2">
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="text" name="voice_id" id="voice_id" value="{{ old('voice_id') }}"
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="text" name="language" id="language" value="{{ old('language', 'en-US') }}"
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <select id="speed" name="speed" 
                                        ...
                                        <option value="1" {{ old('speed', 1) == 1 ? 'selected' : '' }}>Very Slow (1)</option>
                                        <option value="2" {{ old('speed', 1) == 2 ? 'selected' : '' }}>Slow (2)</option>
                                        <option value="3" {{ old('speed', 1) == 3 ? 'selected' : '' }}>Normal (3)</option>
                                        <option value="4" {{ old('speed', 1) == 4 ? 'selected' : '' }}>Fast (4)</option>
                                        <option value="5" {{ old('speed', 1) == 5 ? 'selected' : '' }}>Very Fast (5)</option>
                                    </select>
                                    @error('speed')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <select id="pitch" name="pitch" 
                                        ...
                                        <option value="1" {{ old('pitch', 1) == 1 ? 'selected' : '' }}>Very Low (1)</option>
                                        <option value="2" {{ old('pitch', 1) == 2 ? 'selected' : '' }}>Low (2)</option>
                                        <option value="3" {{ old('pitch', 1) == 3 ? 'selected' : '' }}>Normal (3)</option>
                                        <option value="4" {{ old('pitch', 1) == 4 ? 'selected' : '' }}>High (4)</option>
                                        <option value="5" {{ old('pitch', 1) == 5 ? 'selected' : '' }}>Very High (5)</option>
                                    </select>
                                    @error('pitch')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="col-span-6">
                                    ...
                                    <textarea id="description" name="description" rows="3" 
                                              ...
                                              placeholder="Optional description of this voice option...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
