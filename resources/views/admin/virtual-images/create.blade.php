...
@section('title', 'Add Virtual Image')
...
<div>
    ...
    <div class="mt-8">
        <div class="max-w-3xl mx-auto">
            <form action="{{ route('admin.virtual-images.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                ...
                <div class="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
                    <div class="md:grid md:grid-cols-3 md:gap-6">
                        <div class="md:col-span-1">
                            ...
                            <p class="mt-1 text-sm text-gray-500">
                                Upload and configure your virtual image.
                            </p>
                        </div>
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div class="col-span-6">
                                    ...
                                    <textarea id="description" name="description" rows="3" 
                                              ...
                                              placeholder="Optional description of this virtual image...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
