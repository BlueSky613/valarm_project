...
<div>
    ...
    <div class="mt-8">
        <div class="max-w-3xl mx-auto">
            <form action="{{ route('admin.horoscopes.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
                    <div class="md:grid md:grid-cols-3 md:gap-6">
                        <div class="md:col-span-1">
                            ...
                            <p class="mt-1 text-sm text-gray-500">
                                Enter the horoscope content and metadata.
                            </p>
                        </div>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <select id="sign" name="sign" 
                                        ...
                                        @foreach($signs as $key => $sign)
                                            <option value="{{ $key }}" {{ old('sign') == $key ? 'selected' : '' }}>
                                                {{ $sign }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <textarea id="content" name="content" rows="6" 
                                                  ...
                                                  placeholder="Enter the horoscope text...">{{ old('content') }}</textarea>
                                    </div>
                                    @error('content')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
