    ...
    <div class="md:flex md:items-center md:justify-between">
        <div class="flex-1 min-w-0">
            ...
            <p class="mt-1 text-sm text-gray-500">
                Manage your motivational quotes collection
            </p>
        </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($quotes as $quote)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $quote->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                            {{ $quote->is_active ? 'Active' : 'Inactive' }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        {{ $quote->scheduled_at ? $quote->scheduled_at->format('M j, Y g:i A') : 'Not scheduled' }}
                                    </td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="px-6 py-12 text-center text-sm text-gray-500">
                                        ...
                                        <p>No quotes found. <a href="{{ route('admin.quotes.create') }}" class="text-blue-600 hover:text-blue-500">Create your first quote</a></p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
